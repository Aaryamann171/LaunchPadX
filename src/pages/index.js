  ...
  return (
    <>
      ...
      <div className="bg-foreground flex justify-between p-10">
        <div className="my-auto p-4 w-1/2">
      ...
      <div>
          <div className="w-full flex">
            <h1 className="text-3xl mx-10 mt-10 bg-blue-200 py-4 px-8 rounded-full"><span className="font-bold">Total Launches: </span>{launchesData.totalLaunches}</h1>
            <h1 className="text-3xl mx-10 mt-10 bg-green-200 py-4 px-8 rounded-full"><span className="font-bold">Successful Launches: </span>{launchesData.successfulLaunches}</h1>
          </div>
