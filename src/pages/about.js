...
const About = () => {
    return (
        <div>
            ...
            <div className="mb-10 bg-foreground dark:bg-foregroundDark rounded shadow m-8 p-10">
                <div className="mb-4">
            ...
            <div className="mb-10 bg-foreground dark:bg-foregroundDark rounded shadow m-8 p-4 md:p-10 flex flex-col md:flex-row">
            <div className="md:w-1/3 bg-white dark:bg-black m-4 md:p-8 rounded text-center">
                <Image src={'/me.png'} width={500} height={500} className="m-auto" alt="me"></Image>
            </div>
            <div className="md:w-2/3 p-4 m-auto">
                <p className="text-xl mt-4 text-slate-800 dark:text-slate-300">
